...
_SYSTEM_CONFIG = """
  ...
  bodies {
    name: "North_Wall"
    colliders {
      box { halfsize { x: 12.5 y: 1.2 z: 0.75} }
  ...
  bodies {
    name: "Top_Right_Wall"
    colliders {
      box { halfsize { x: 22.4 y: 1.2 z: 0.75} }
      position {x: 32.5 y: 46.2 z: 0.75}
    }
    frozen { all: true }
  }
  bodies {
  ...
  bodies {
    name: "South_Wall"
    colliders {
      box { halfsize { x: 33.7 y: 1.2 z: 0.75} }
      position {x: 21.2 y: -6.2 z: 0.75}
    }
    frozen { all: true }
  }
  bodies {
